...
abstract class $LoginCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: "otp") String? otp, @JsonKey(name: "user") bool? user});
}
...
class _$LoginImpl implements _Login {
  const _$LoginImpl(
      {@JsonKey(name: "otp") this.otp, @JsonKey(name: "user") this.user});
  ...
  @override
  String toString() {
    return 'Login(otp: $otp, user: $user)';
  }
...
abstract class _Login implements Login {
  const factory _Login(
      ...
      @JsonKey(name: "user") final bool? user}) = _$LoginImpl;
